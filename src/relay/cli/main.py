...
def _initialize(project: Path, swarm: str, test_command: str) -> None:
    ...
    config.write_text(
        ...
        "# opus where a better model changes what you live with: the Interpreter\n"
        "# is the Owner's entire experience of the swarm and writes the roadmap,\n"
        "# and the analyst's reading of the problem shapes every story after it\n"
        "# (both are a handful of turns); sonnet elsewhere. Gates stay on sonnet\n"
        "# on purpose: a cheap gate does not save money, it defers a bug.\n"
